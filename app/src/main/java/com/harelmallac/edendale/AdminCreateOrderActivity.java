...
public class AdminCreateOrderActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LV = findViewById(R.id.AdcusListView);
...
//                Toast.makeText(getApplicationContext(),x,Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        String cusName = null;
        Intent intent = new Intent(AdminCreateOrderActivity.this, AdminCreateOrderDetailsActivity.class);
